...
\date{{\bf AAAI Fall Symposium -- AI-HRI Workshop} -- 09 nov. 2017}
...
\imageframe[scale=0.95]{freeplay/freeplay-sandbox-architecture-record}
\imageframe[scale=0.95]{freeplay/freeplay-sandbox-architecture-policy}
\imageframe[scale=0.95]{freeplay/freeplay-sandbox-architecture-robot}
\imageframe[scale=0.95]{freeplay/freeplay-sandbox-architecture-practical}
\imageframe[scale=0.95]{freeplay/freeplay-sandbox-architecture}
...
\begin{frame}[plain]
    ...
    \begin{center}
        ...
        \href{https://github.com/freeplay-sandbox/}{\bf github.com/freeplay-sandbox}
...
\begin{frame}{What should we observe?}
    ...
    \pause
    $\rightarrow$ {\bf the free play sandbox is paradigm for socio-cognitive investigation}
\end{frame}
...
\videoframe[0.56]{figs/raw_annotations.mp4?autostart}
...
\videoframe[0.56]{figs/annotations.mp4?autostart}
